...
public class MyAdvice {
	...
	public ResponseEntity<?> userPasswordNotMatchException() {
		return ResponseEntity.status(HttpStatus.NOT_FOUND.value()).body(new ResultDto(HttpStatus.NOT_FOUND.value(), "비밀번호가 일치하지 않습니다."));
	}
